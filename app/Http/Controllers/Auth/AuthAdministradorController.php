...
class AuthAdministradorController extends Controller
{
    ...
    protected $registerView = 'administradores.register';
    ...
    protected function validator(array $data)
    {
        return Validator::make($data, [
            "rut" => "required|unique:apoderados|unique:profesores|unique:administrativos|unique:alumnos|unique:administradores",
    ...
    public function register(AdministradorRequest $request){
