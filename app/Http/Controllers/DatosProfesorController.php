...
class DatosProfesorController extends Controller
{
    ...
    public function verCalificacion($id, $idasi)
    {
        ...
        $mis_notas = DB::table('calificaciones as cal')
            ...
            ->select('cal.id', 'cal.n1', 'cal.n2', 'cal.n3', 'cal.n4', 'cal.n5', 'cal.n6', 'cal.n7', 'cal.n8', 'cal.cantidad', 'cal.promedio', 'cal.examen', 'cal.final', 'cal.observacion', 'cal.id_alumno',  'cal.id_asignatura')
            ->where('cal.id','<>',null)
